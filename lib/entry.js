...
function yarnToNpmResolved (version, yarnResolved, versions, name) {
...
module.exports = {
  npmEntry (nodeModulesTree, yarnObject, mPath, versions) {
    ...
    const entry = yarnToNpmResolved(version, yarnResolved, versions, name)
